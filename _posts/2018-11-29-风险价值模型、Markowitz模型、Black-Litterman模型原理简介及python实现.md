...
$$Pr\left\{X_t<-\mathit{VaR}(\alpha,\Delta t)\}=\alpha%$$
...
$$
\mathit{max}\limits_{\omega_i} \mathbb{E}[U(R_p)]=\mathbb{E}[U(\sum_{i=1}^{N}\omega_i R_i)]\\
...
$$
\mathit{min}\limits_{\omega_i}\sigma^2(R_p)=\sum_{i=1}^{N}\omega_i^2\sigma^2(R_i)+\sum_{i\neq j}\omega_i\omega_j\sigma(R_i,R_j)\\
